    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-plus"></i> <strong>Reset Password</strong>
            </h1>
            <!-- END Register Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <!-- Register Form -->
                <?php echo form_open('login/ubah_proses/'.$id) ?>
                <div id="form-register" class="form-horizontal">
                    <?php if($this->session->flashdata('suksesubah')!=""){
                        $link =  '<a href="">Login</a>';
                        echo '<div class="alert alert-success"><strong>Sukses!</strong> Password Berhasil Diubah, Silahkan Login </div>';
                    }?>
                    <?php if($this->session->flashdata('errorubah')!=""){
                        echo '<div class="alert alert-danger"><strong>Error!</strong> Data Gagal Diubah</div>';
                    }?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" id="register-password-verify" name="register-password-verify" class="form-control" placeholder="Verifikasi Password">
                            <?php echo form_error('register-password-verify') ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
