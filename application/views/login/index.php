    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <br> <strong>Selamat Datang di SIWARKOP</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <div class="block-title">
                    <div class="block-options pull-right">
                        <a href="<?php echo site_url('login/lupa'); ?>" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Lupa password?"><i class="fa fa-exclamation-circle"></i></a>
                ...
                ?>
                <!-- Login Form -->
                <form id="form-login" action="<?php echo site_url('login/login_user') ?>" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="text" name="username" class="form-control" placeholder="Masukkan Username atau E-mail.." autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
