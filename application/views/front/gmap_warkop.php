        ...
        <script type="text/javascript">
            ...
                var trafficLayer = new google.maps.TrafficLayer({map : map});
                ...
                <?php if (isset($warkop_detail)){ ?>
                    <?php
                        $lat = $warkop_detail["lat"];
                        $lon = $warkop_detail["lng"];
                        $nama = '<strong>'.$warkop_detail["nama_warkop"].'</strong><br>'.$warkop_detail["alamat"];
                ...
                var infoWindow3 = new google.maps.InfoWindow({map: map});
                    ...
                    infoWindow3.setContent('<strong><?php echo $warkop_detail["nama_warkop"] ?></strong>');
